...
export default function WebhookSetupWizard() {
  ...
  const [, setCreatedWebhook] = useState<CreatedWebhook | null>(null);
  ...
  const steps = [
    ...
    { number: 2, title: "Webhook URL", icon: Code },
    { number: 3, title: "Choose Events", icon: Settings },
    { number: 4, title: "Generate Webhook", icon: Key },
    { number: 5, title: "Integration Ready", icon: Zap },
  ];
    ...
    switch (currentStep) {
      case 1:
        return (
          ...
          >
            <div>
              <h3 className="text-lg font-semibold mb-2">Choose your product</h3>
      ...
      case 2:
        return (
          ...
          >
            <div>
              <h3 className="text-lg font-semibold mb-2">Webhook endpoint URL</h3>
              <p className="text-gray-600 mb-4">
      ...
      case 3:
        return (
          ...
          >
            <div>
              <h3 className="text-lg font-semibold mb-2">Select webhook events</h3>
              <p className="text-gray-600 mb-4">
      ...
      case 4:
        return (
          ...
          >
            <div>
              <h3 className="text-lg font-semibold mb-2">Create webhook</h3>
              <p className="text-gray-600 mb-4">
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold">Webhook Setup Wizard</h1>
