...
const Content = forwardRef((_, ref: LegacyRef<HTMLElement>) => {
    return (
        <section ref={ref} className="w-full py-12 md:py-24 lg:py-32 bg-muted">
            <div className="px-4 md:px-6">
                ...
                <div className="mx-auto font-sans grid items-start gap-6 sm:max-w-4xl sm:grid-cols-2 md:gap-8 lg:max-w-6xl lg:grid-cols-3">
